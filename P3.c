...
int main()
{
    int ch,id,k,i;
    char c,pas[50];
    SetConsoleTitle("COLLEGE INFORMATION SYSTEM | GUNI-ICT");
    FILE * fp;
    Student s;
    int option;
    char another;
    ...
    system("color 9f");
	gotoxy(42,8);
	printf("LOGIN(If  press ENTER to continue......)");
	gotoxy(42,10);
    ...
    if(strcmp(pas,pa.pass)==0)
	{
        ...
        printf(" \n\n\n\n\n\t\t\t\t\t     *  *  *  *  *  *  *  *  *  *  *  *  *  *  *  *  *  *  *  *  *             ");
		printf("\n\n\t\t\t\t\t     *                    *");
		printf("\n\n\t\t\t\t\t     *       Welcome  to the COLLEGE INFORMATION SYSTEM [G-23]                          ");
		printf("\n\n\t\t\t\t\t     *                    *");
		printf("\n\n\t\t\t\t\t     *  *  *  *  *  *  *  *  *  *  *  *  *  *  *  *  *  *  *  *  *  *  *            ");
    ...
    title();
    printf("\n\n\t\t\t\t SEM 1 2021 BATCH 15  ");
    printf("\n\n\t\t\t\t   ANSH PATEL , ATHARVA DESHPANDE , KRISH PATEL  ");
    printf("\n\n\t\t\t  GUNI - ICT \n\t\t\t");
    printChar('=',38);
    ...
    while(1)
    {
        ...
        printf("\n\n\t\t\t\t4. Display Individual Student Records :");
        printf("\n\n\t\t\t\t5. Remove Student from records :");
        printf("\n\n\t\t\t\t6. Change Password :");
        printf("\n\n\t\t\t\t7. Logout\n\t");
        printChar('*',64);
        printf("\n\n\t\t\t\tEnter Your Option :--> ");
...
FILE * del(FILE * fp)
{
    ...
    printf("\n\n\tEnter Enrollment number of Student to Delete the Record");
    printf("\n\n\t\t\tRoll No. : ");
    scanf("%d",&tempRoll);
...
void modify(FILE * fp)
{
    ...
    printf("\n\n\tEnter Enrollment Number of Student to MODIFY the Record : ");
    scanf("%d",&tempRoll);
